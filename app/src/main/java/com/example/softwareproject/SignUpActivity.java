...
public class SignUpActivity extends AppCompatActivity {
    ...
    public void signUp(View view) {
        ...
        if (mImageView.getDrawable() == null) {
            Toast.makeText(getApplicationContext(), "Picture needed to join", Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    public void submit(String filename){
        ...
        final StorageReference storageReference =FirebaseStorage.getInstance().getReference().child("documentImages").child(filename);
